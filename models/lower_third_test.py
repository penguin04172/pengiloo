...
class TeamTest(unittest.TestCase):
    ...
    def test_lower_third_crud(self):
        ...
        lower_third = create_lower_third(LowerThird(top_text="Top Text", bottom_text="Bottom Text", display_order=1))
    ...
    def test_truncate_lower_thirds(self):
        lower_third = create_lower_third(LowerThird(top_text="Top Text", bottom_text="Bottom Text", display_order=0))
    ...
    def test_read_lower_third_by_award_id(self):
        ...
        lower_third_1 = create_lower_third(LowerThird(top_text="Top Text", bottom_text="Bottom Text", display_order=1))
        lower_third_2 = create_lower_third(LowerThird(top_text="Award 1", bottom_text="", display_order=2, award_id=5))
        lower_third_3 = create_lower_third(LowerThird(top_text="Award 2", bottom_text="", display_order=3, award_id=2))
        lower_third_4 = create_lower_third(LowerThird(top_text="Award 1", bottom_text="Award 1 Winner", display_order=4, award_id=5))
        lower_third_list = read_all_lower_thirds()
