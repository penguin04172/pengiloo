...
def read_off_field_team_ids(match: Match):
    red_off_field_teams = read_off_field_team_ids_for_alliance(match.playoff_red_alliance, match.red1, match.red2, match.red3)
    blue_off_field_teams = read_off_field_team_ids_for_alliance(match.playoff_blue_alliance, match.blue1, match.blue2, match.blue3)

    return red_off_field_teams, blue_off_field_teams


def read_off_field_team_ids_for_alliance(alliance_id: int, team_id_1: int, team_id_2: int, team_id_3: int):
    if alliance_id == 0:
        return []
