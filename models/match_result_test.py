...
class MatchResultTest(unittest.TestCase):
    ...
    def build_test_match_result(self, match_id: int, play_number: int):
        match_result = MatchResult(match_id=match_id, play_number=play_number, match_type=MATCH_TYPE.qualification)
    ...
    def test_match_result_crud(self):
        ...
        match_result.blue_score.endgame_statuses = [ENDGAME_STATUS.park, ENDGAME_STATUS.none, ENDGAME_STATUS.stage_right]
