...
class EventDB(db.Entity):
    ...
    warning_remaining_duration_sec = Required(int, default=match_timing.warning_remaining_duration_sec)
    melody_bonus_threshold_without_coop = Required(int, default=game_specific.melody_bouns_threshold_without_coop)
    melody_bonus_threshold_with_coop = Required(int, default=game_specific.melody_bonus_threshold_with_coop)
