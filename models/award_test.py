...
class TestAlliance(unittest.TestCase):
    ...
    def test_read_award_by_type(self):
        award_1 = create_award(
            Award(type=AwardType.winner_award, award_name='Event Winner', team_id=6998)
        )
        award_2 = create_award(
            Award(type=AwardType.finalist_award, award_name='Event Finalist', team_id=8121)
        )
        award_3 = create_award(
            Award(type=AwardType.judged_award, award_name='Safety Award', team_id=7641)
        )
        award_4 = create_award(
            Award(type=AwardType.winner_award, award_name='Event Winner', team_id=7641)
        )
