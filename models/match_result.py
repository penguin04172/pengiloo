...
class MatchResult(BaseModel):
    ...
    def correct_playoff_score(self):
        self.red_score.playoff_dq = "red" in self.red_cards.values() or "dq" in self.red_cards.values()
        self.blue_score.playoff_dq = "red" in self.blue_cards.values() or "dq" in self.blue_cards.values()
