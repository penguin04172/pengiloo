...
class EventTest(unittest.TestCase):
    ...
    def test_event_read_write(self):
        event = Event(
            ...
            coral_bonus_level_threshold_without_coop=4,
            coral_bonus_level_threshold_with_coop=3,
        )
        ...
        self.assertEqual(
            event.coral_bonus_level_threshold_without_coop,
            event_settings.coral_bonus_level_threshold_without_coop,
        )
        self.assertEqual(
            event.coral_bonus_level_threshold_with_coop,
