...
class EventTest(unittest.TestCase):
    ...
    def test_event_read_write(self):
        ...
        self.assertEqual(event.warning_remaining_duration_sec, event_settings.warning_remaining_duration_sec)
        self.assertEqual(event.melody_bonus_threshold_without_coop, event_settings.melody_bonus_threshold_without_coop)
        self.assertEqual(event.melody_bonus_threshold_with_coop, event_settings.melody_bonus_threshold_with_coop)
        self.assertEqual(event.amplification_note_limit, event_settings.amplification_note_limit)
        self.assertEqual(event.amplification_duration_sec, event_settings.amplification_duration_sec)
