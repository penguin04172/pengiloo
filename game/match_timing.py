...
def get_duration_to_teleop_start():
    return match_timing.warmup_duration_sec + match_timing.auto_duration_sec + match_timing.pause_duration_sec

def get_duration_to_teleop_end():
    return match_timing.warmup_duration_sec + match_timing.auto_duration_sec + match_timing.pause_duration_sec + match_timing.teleop_duration_sec