...
class AmpSpeakerTest(unittest.TestCase):
    ...
    def test_amp_speaker_match_sequence(self):
        amp_speaker = AmpSpeaker()
        def assert_amp_speaker(auto_amp_notes, teleop_amp_notes, auto_speaker_notes, teleop_unamplified_speaker_notes, teleop_amplified_speaker_notes):
            ...
            self.assertEqual(teleop_unamplified_speaker_notes, amp_speaker.teleop_unamplified_speaker_notes)
            self.assertEqual(teleop_amplified_speaker_notes, amp_speaker.teleop_amplified_speaker_notes)
        ...
        self.assertEqual(True, amp_speaker.is_coop_window_open(match_start_time, time_after_start(1)))
        ...
        self.assertEqual(True, amp_speaker.is_coop_window_open(match_start_time, time_after_start(62.9)))
        ...
        amp_speaker = AmpSpeaker()
        assert_amp_speaker(0, 0, 0, 0, 0)
        self.assertEqual(False, amp_speaker.is_coop_window_open(match_start_time, time_after_start(63.1)))
        ...
        assert_amp_speaker(0, 1, 0, 0, 0)
        self.assertEqual(1, amp_speaker.banked_amp_notes)
        self.assertEqual(True, amp_speaker.is_coop_window_open(match_start_time, time_after_start(60)))
        game_specific.melody_bonus_threshold_with_coop = 0
        self.assertEqual(False, amp_speaker.is_coop_window_open(match_start_time, time_after_start(60)))
        ...
        game_specific.amplification_note_limit = 3
        game_specific.amplification_duration_sec = 6
        ...
        game_specific.amplification_duration_sec = 23
        ...
        # Restore default
        game_specific.amplification_note_limit = 4
        game_specific.amplification_duration_sec = 10
