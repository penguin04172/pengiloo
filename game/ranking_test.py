...
class TestRanking(unittest.TestCase):
    ...
    def test_add_score_summary(self):
        ...
        self.assertEqual(ranking_fields, RankingField(
            ranking_points=1,
    ...
    def test_sort_rankings(self):
        rankings = Rankings()
        rankings.append(Ranking(team_id=1, rank=0, previous_rank=0, fields=RankingField(
            ranking_points=50,
        ...
        rankings.append(Ranking(team_id=2, rank=0, previous_rank=0, fields=RankingField(
            ranking_points=50,
            coopertition_points=50,
            match_points=50,
            auto_points=50,
        ...
        rankings.append(Ranking(team_id=3, rank=0, previous_rank=0, fields=RankingField(
            ranking_points=50,
            coopertition_points=50,
            match_points=50,
            auto_points=50,
        ...
        rankings.append(Ranking(team_id=4, rank=0, previous_rank=0, fields=RankingField(
            ranking_points=50,
            coopertition_points=50,
            match_points=50,
            auto_points=50,
        ...
        rankings.append(Ranking(team_id=5, rank=0, previous_rank=0, fields=RankingField(
            ranking_points=50,
            coopertition_points=50,
            match_points=50,
            auto_points=49,
        ...
        rankings.append(Ranking(team_id=6, rank=0, previous_rank=0, fields=RankingField(
            ranking_points=50,
            coopertition_points=50,
            match_points=50,
            auto_points=51,
        ...
        rankings.append(Ranking(team_id=7, rank=0, previous_rank=0, fields=RankingField(
            ranking_points=50,
            coopertition_points=50,
            match_points=49,
            auto_points=50,
        ...
        rankings.append(Ranking(team_id=8, rank=0, previous_rank=0, fields=RankingField(
            ranking_points=50,
            coopertition_points=50,
            match_points=51,
            auto_points=50,
        ...
        rankings.append(Ranking(team_id=9, rank=0, previous_rank=0, fields=RankingField(
            ranking_points=50,
        ...
        rankings.append(Ranking(team_id=10, rank=0, previous_rank=0, fields=RankingField(
            ranking_points=50,
        ...
        rankings.append(Ranking(team_id=11, rank=0, previous_rank=0, fields=RankingField(
            ranking_points=49,
            coopertition_points=50,
            match_points=50,
            auto_points=50,
        ...
        rankings.append(Ranking(team_id=12, rank=0, previous_rank=0, fields=RankingField(
            ranking_points=51,
            coopertition_points=50,
            match_points=50,
            auto_points=50,
