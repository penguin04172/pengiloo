...
class ScoreTest(unittest.TestCase):
    ...
    def score_2(self) -> Score:
        return Score(
            ...
            endgame_statuses=[ENDGAME_STATUS.stage_left, ENDGAME_STATUS.stage_center, ENDGAME_STATUS.stage_center],
            microphone_statuses=[False, True, True],
    ...
    def test_score_ensemble_bonus_ranking_point(self):
        ...
        score.endgame_statuses = [ENDGAME_STATUS.stage_left, ENDGAME_STATUS.stage_center, ENDGAME_STATUS.stage_right]
        self.assertEqual(False, score.summarize(Score()).ensemble_bonus_ranking_point)

        # Try various combinations of Harmony
        score.endgame_statuses = [ENDGAME_STATUS.stage_left, ENDGAME_STATUS.stage_center, ENDGAME_STATUS.stage_left]
        ...
        score.endgame_statuses = [ENDGAME_STATUS.stage_center, ENDGAME_STATUS.stage_center, ENDGAME_STATUS.stage_left]
        self.assertEqual(True, score.summarize(Score()).ensemble_bonus_ranking_point)
        score.endgame_statuses = [ENDGAME_STATUS.stage_center, ENDGAME_STATUS.stage_center, ENDGAME_STATUS.stage_right]
        self.assertEqual(True, score.summarize(Score()).ensemble_bonus_ranking_point)
        score.endgame_statuses = [ENDGAME_STATUS.stage_right, ENDGAME_STATUS.stage_right, ENDGAME_STATUS.stage_center]
        self.assertEqual(True, score.summarize(Score()).ensemble_bonus_ranking_point)
        score.endgame_statuses = [ENDGAME_STATUS.stage_center, ENDGAME_STATUS.stage_center, ENDGAME_STATUS.stage_center]
        ...
        self.assertEqual(True, score.summarize(Score()).ensemble_bonus_ranking_point)
        score.endgame_statuses = [ENDGAME_STATUS.none, ENDGAME_STATUS.stage_right, ENDGAME_STATUS.stage_right]
        score.microphone_statuses = [False, False, True]
        self.assertEqual(10, score.summarize(Score()).stage_points)
        self.assertEqual(True, score.summarize(Score()).ensemble_bonus_ranking_point)
        score.endgame_statuses = [ENDGAME_STATUS.park, ENDGAME_STATUS.stage_center, ENDGAME_STATUS.stage_right]
        ...
        score.microphone_statuses = [False, False, False]
        score.endgame_statuses = [ENDGAME_STATUS.stage_left, ENDGAME_STATUS.stage_center, ENDGAME_STATUS.park]
        score.trap_statuses = [False, False, True]
        self.assertEqual(12, score.summarize(Score()).stage_points)
        self.assertEqual(True, score.summarize(Score()).ensemble_bonus_ranking_point)
        score.endgame_statuses = [ENDGAME_STATUS.park, ENDGAME_STATUS.stage_center, ENDGAME_STATUS.park]
